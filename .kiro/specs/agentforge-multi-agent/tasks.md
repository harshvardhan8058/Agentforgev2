...
- [x] 1. Extend settings and scaffold the `multiagent/` package with interfaces and stubs
...
- [x]* 1.1 Write a structural/smoke test for the package layout and interface abstractness
...
- [x] 2. Implement the domain models, `Blackboard_State`, and bound resolution
  - [x] 2.1 Implement `multiagent/models.py` domain dataclasses
  ...
  - [x] 2.2 Implement `multiagent/state.py` — `Blackboard_State` and bound resolution
  ...
  - [x]* 2.3 Write property test for Max_Rounds resolution
    - **Property 5: Max_Rounds resolution**
    - **Validates: Requirements 2.5, 2.6**

  - [x]* 2.4 Write property test for Max_Revisions resolution
    - **Property 6: Max_Revisions resolution**
    - **Validates: Requirements 3.5, 3.6**

  - [x]* 2.5 Write unit tests for model/state construction edge cases
...
- [x] 3. Implement the `Agent_Role_Interface`, registry, and declarative pipeline
  - [x] 3.1 Implement `roles/base.py` registry and pipeline
  ...
  - [x]* 3.2 Write property test for the add-a-role interface round-trip
    - **Property 9: Add-a-role interface round-trip**
    - **Validates: Requirements 1.4**

- [x] 4. Implement the four built-in Agent_Roles over the reused Agent_Orchestrator
  - [x] 4.1 Implement `Planner_Agent` (`roles/planner.py`)
  ...
  - [x] 4.2 Implement `Researcher_Agent` (`roles/researcher.py`)
  ...
  - [x] 4.3 Implement `Writer_Agent` (`roles/writer.py`)
  ...
  - [x] 4.4 Implement `Critic_Agent` (`roles/critic.py`)
  ...
  - [x]* 4.5 Write unit tests for role delegation and distinct instructions
...
- [x] 5. Implement the Multi_Agent_Orchestrator and LangGraph state graph
  - [x] 5.1 Implement `multiagent/graph.py` — role nodes and conditional routing
  ...
  - [x] 5.2 Implement `multiagent/orchestrator.py` — build and run the graph
...
- [x] 7. Implement the Approval_Policy seam and Human_Approval_Gate
  - [x] 7.1 Implement `multiagent/approval.py` policies and gate
...
- [x] 8. Implement the Multi_Agent_Streaming_Service
  ...
  - [x]* 8.2 Write property test for streaming terminal/order/attribution guarantees
  ...
  - [x]* 8.3 Write property test for auto-approve determinism (output + event sequence)
    - **Property 13: Auto-approve determinism of final output and event sequence**
    - **Validates: Requirements 1.5, 3.7, 5.6, 7.9, 12.1**

  - [x]* 8.4 Write unit tests for incremental and approval_required emission
...
- [x] 9. Wire per-agent tracing through the reused Trace_Recorder
  ...
  - [x]* 9.1 Write property test for complete, ordered, role-attributed trace
    - **Property 15: Trace is complete, ordered by ordinal, and role-attributed**
    - **Validates: Requirements 6.1, 6.3**

- [x] 10. Implement persistence: migration and Multi_Agent_Run_Store
  - [x] 10.1 Add migration `migrations/0005_create_multi_agent_runs.sql`
  ...
  - [x] 10.2 Implement `multiagent/store.py` — ABC + InMemory + Pg implementations
...
- [x] 11. Extend the composition root to wire the multi-agent context
  ...
  - [x]* 11.1 Write unit tests for the composition root wiring
...
- [x] 12. Implement the API endpoints and register the router
  - [x] 12.1 Extend `api/schemas.py` and `api/deps.py`
  ...
  - [x] 12.2 Implement `api/routers/multi_agent.py` and register it in `main.py`
  ...
  - [x]* 12.3 Write keyless API integration tests
...
- [x] 13. Extend `docs/decisions.md` with the multi-agent design decisions
  ...
  - [x] 13.1 Checkpoint - docs and wiring review
